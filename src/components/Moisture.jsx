...
*/}
                  <h3 className="text-lg font-bold text-amber-900 mb-1">{product.title}</h3>
                  <p className="text-sm text-[#7ca4a1] mb-2">{product.desc}</p>

                  {/* Centered Price + Discount */}
                  <div className="flex justify-center items-center gap-2 mb-3">
                    <span className="text-sm line-through text-gray-400">${product.price}</span>
                    <span className="text-lg font-bold text-fuchsia-950">${product.discountedPrice}</span>
                  </div>
